      ...
      <li
        ...
        <p>
          ...
          <span class="acts">
            ...
            <el-button type="text" @click="editVideo(chapter.id)">编辑</el-button>
          <el-button type="text" @click="removeChapterById(chapter.id)">删除</el-button>          </span>
        </p>
        <!-- 视频 -->
