            ...
            <ol class="js-tap clearfix">
              <li :class="{'current bg-green': $route.query.buyCountSort}">
                <a
                  title="销量"
                  href="javascript:void(0);"
                  @click="searchObjByCount()">销量
                  <i>↓</i>
                </a>
              </li>
              <li>
                <a
                  :class="{'current bg-green': $route.query.gmtCreateSort}"
                  title="最新"
                  href="javascript:void(0);"
              ...
              <li>
                <a
                  ...
                  :class="{'current bg-green': $route.query.priceSort}"
                  title="价格"
                  href="javascript:void(0);"
